...
public final class ActivityThread {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case LAUNCH_ACTIVITY: {
                    ...
                    Log.v("yihao", "LAUNCH_ACTIVITY");
                    Log.v("yihao", "processName " + r.activityInfo.applicationInfo.processName);
                    Log.v("yihao", "className " + r.activityInfo.applicationInfo.className);
    ...
    public Application getApplication() {
        Log.v("yihao", "ActivityThread#getAppliction()");
        if(null != mInitialApplication){
            Log.v("yihao", "mInitialApplication " + mInitialApplication.getClass().getCanonicalName());
        }
    ...
    private void handleBindApplication(AppBindData data) {
        Log.v("yihao", "handleBindApplication");
        ...
        Log.v("yihao", "getPackageInfoNoCheck");
        Log.v("yihao", "data.appInfo processName " + data.appInfo.processName);
        Log.v("yihao", "data.appInfo className " + data.appInfo.className);
